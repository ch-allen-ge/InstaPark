angular.module('InstaPark').controller('NorthWestController', ['$http', '$scope', 'parkingFactory', function($http, $scope, parkingFactory) {

    var store = this;
    store.displayInfo = null; 
    store.length = 0;
    $scope.northwestCarArray = [];  
    ...
    store.getParkingData = function() {
        ...
        .then(function transferData(response) {
            ...
            parkingFactory.setNorthwestCars(store.displayInfo);
            ...
            $scope.northwestCarArray = theArray;  
        })
    }
...
angular.module('InstaPark').directive("northwestView", function() {
    return {
        restrict: "E",
        templateUrl: "../templates/northwest/index.html"
    };
});
